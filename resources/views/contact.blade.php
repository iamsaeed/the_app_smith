        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <p class="text-lg text-gray-600 mb-8">
              Whether you have a question about my services, need a consultation, or are ready to start a project,
              I'm here to help. Fill out the form or use the contact information below to reach out.
            </p>
          ...
          <div class="bg-gray-50 rounded-lg p-8 shadow-md">
            ...
            <form action="{{ route('contact.submit') }}" method="POST">
              ...
              <div class="mb-6">
                ...
                <input type="text" id="name" name="name" value="{{ old('name') }}" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                @error('name')
              ...
              <div class="mb-6">
                ...
                <input type="email" id="email" name="email" value="{{ old('email') }}" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                @error('email')
                  <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                @enderror
              </div>
              ...
              <div class="mb-6">
                ...
                <input type="text" id="subject" name="subject" value="{{ old('subject') }}" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                @error('subject')
                  <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                @enderror
              </div>
              ...
              <div class="mb-6">
                ...
                <textarea id="message" name="message" rows="5" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>{{ old('message') }}</textarea>
                @error('message')
                  <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                @enderror
              </div>
      ...
      <div class="max-w-6xl mx-auto">
        ...
        <div class="h-96 bg-gray-300 rounded-lg overflow-hidden shadow-md">
          ...
          <div class="w-full h-full flex items-center justify-center">
            <p class="text-gray-700">Interactive Map Placeholder</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      <div class="max-w-6xl mx-auto">
        <div class="text-center mb-12">
          ...
          <p class="text-lg text-gray-600 max-w-2xl mx-auto">
            Common questions about my services and how I work
          </p>
        </div>
        ...
        <div class="space-y-6">
          ...
          <div x-data="{ open: false }" class="border border-gray-200 rounded-lg">
            <button @click="open = !open" class="flex justify-between items-center w-full px-6 py-4 text-left focus:outline-none">
              <span class="font-medium text-gray-900">What is your typical process for a new project?</span>
            ...
            <div x-show="open" class="px-6 pb-4 pt-0" style="display: none;">
              <p class="text-gray-600">I follow a comprehensive process that includes requirements gathering, planning, design, development, testing, and deployment. I'll keep you involved at every stage to ensure the final product meets your expectations.</p>
            </div>
          </div>
          ...
          <div x-data="{ open: false }" class="border border-gray-200 rounded-lg">
            <button @click="open = !open" class="flex justify-between items-center w-full px-6 py-4 text-left focus:outline-none">
              <span class="font-medium text-gray-900">How do you charge for your services?</span>
              <svg :class="{'rotate-180': open}" class="w-5 h-5 text-gray-500 transform transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
              </svg>
            </button>
            <div x-show="open" class="px-6 pb-4 pt-0" style="display: none;">
              <p class="text-gray-600">I offer both hourly rates and fixed project pricing depending on the scope and requirements. After our initial consultation, I'll provide a detailed proposal with transparent pricing for your consideration.</p>
            </div>
          </div>
          ...
          <div x-data="{ open: false }" class="border border-gray-200 rounded-lg">
            <button @click="open = !open" class="flex justify-between items-center w-full px-6 py-4 text-left focus:outline-none">
              <span class="font-medium text-gray-900">What technologies do you specialize in?</span>
              <svg :class="{'rotate-180': open}" class="w-5 h-5 text-gray-500 transform transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
              </svg>
            </button>
            <div x-show="open" class="px-6 pb-4 pt-0" style="display: none;">
              <p class="text-gray-600">I specialize in modern web technologies including Laravel, Vue.js, React, Node.js, and more. I also work with mobile app frameworks like React Native and Flutter. My expertise allows me to choose the right technology stack for your specific project needs.</p>
            </div>
          </div>
        </div>
      </div>
