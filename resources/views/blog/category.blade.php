<x-app-layout>
    <x-slot name="title">{{ $category->name }} - Blog Category</x-slot>
    <x-slot name="meta_description">Browse all blog posts in the {{ $category->name }} category.</x-slot>
    <x-slot name="meta_keywords">{{ $category->name }}, blog, category</x-slot>
    ...
    <section class="relative pt-24 md:pt-28 lg:pt-32 pb-12 bg-gradient-to-r from-blue-50 to-indigo-50">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="max-w-4xl mx-auto text-center">
                <div class="inline-block px-4 py-1.5 mb-3 text-xs font-semibold leading-5 text-indigo-800 rounded-full bg-indigo-100">Category</div>
        ...
        <div class="container mx-auto px-4 py-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden flex flex-col h-full">
                    ...
                    <div class="p-6 flex-1 flex flex-col">
                        ...
                        <div class="flex flex-wrap gap-2 mb-3">
                            @foreach($blog->categories->take(2) as $blogCategory)
                            <a href="{{ url('blog/category/' . $blogCategory->slug) }}" class="bg-indigo-100 text-indigo-800 px-2 py-1 rounded-full text-xs font-medium hover:bg-indigo-200">
                                {{ $blogCategory->name }}
                            </a>
                            @endforeach
                        </div>
                ...
                <div class="col-span-3 text-center py-12">
                    <h3 class="text-xl text-gray-500">No blog posts found in this category.</h3>
